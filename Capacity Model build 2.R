...
ctrl.grid1 <- makeTuneControlGrid(resolution = 10)

params1 <- makeParamSet(makeIntegerParam("nrounds", lower = 50L, upper = 150L),
...
params2 <- makeParamSet(makeIntegerParam("max_depth",lower = 3L,upper = 10L),
...
ctrl.rand3 <- makeTuneControlIrace(maxExperiments = 100L)
...
trained_model = train(xgb.params3.lrn, O.log.task)
